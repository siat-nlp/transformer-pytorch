...
def load_file(inst_file, max_sent_len, keep_case=False):
...
def main():
    ...
    # Training set
    train_src_word_insts = load_file(args.train_src, args.max_word_seq_len, args.keep_case)
    train_tgt_word_insts = load_file(args.train_tgt, args.max_word_seq_len, args.keep_case)
